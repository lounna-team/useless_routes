module UselessRoutes
  class ReporterPresenter
    ...
    def report
      puts "#{'Route'.pluralize(routes_without_views.size)} without view : #{routes_without_views.size} ".black.on_white
      puts "#{'Route'.pluralize(routes_without_actions.size)} without action : #{routes_without_actions.size}".black.on_white
      puts "#{'View'.pluralize(views_without_actions.size)} without action : #{views_without_actions.size}".black.on_white
      puts "#{'View'.pluralize(views_without_routes.size)} without action : #{views_without_routes.size}".black.on_white
